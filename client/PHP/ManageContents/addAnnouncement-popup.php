<?php
    ...
    if(isset($_GET['addAnnouncementBTN']) && $_SESSION['type']!="co-admin"){
        echo '
            <div class="backdrop">
                <form method="post" action="../../server/content_handler.php" class="form-holder animation-fadeIn" enctype="multipart/form-data">
                    <div class="form-holder-title">
                        <h2><i class="bi bi-plus-circle"></i> ADD NEW ANNOUNCEMENT</h2>
                    </div>
                    <div class="form-row">
                        <div class="form-col">
                            ...
                            <div class="input-holder">
                                ...
                                <input type="file" name="announceIMG" required>
                            </div>
                            <div class="input-holder">
                        ...
                        <div class="form-col">
                            <div class="input-holder">
                                <label for="">Announcement Summary:</label>
                                <textarea name="Summary" id="" cols="30" rows="3"></textarea>
                            </div>
                            <div class="input-holder">
                    ...
                    <div class="form-button-holder">
                        <button name="addAnnouncementBTN">ADD</button>
