<?php
    ...
    //SELECT EMAIL AUTOMATION
        $sql = "SELECT * FROM tbl_emailtemplates WHERE type = 'deletion_account' LIMIT 1";
    ...
    <section>
        ...
        <div class="content-holder">
            <div class="action-buttons">
                ...
                <a href="emailTemplates-deletion.php" name="formsBTN" class="selected">
                    <i class="bi bi-envelope-arrow-up-fill"></i>
        ...
        <div class="content-holder">
            <form action="../../server/email_manipulation.php" method="get">
                ...
                <div class="button-holder">
                    <button name="approve_account" value="<?php echo $id?>"><i class="bi bi-floppy"></i> SAVE</button>
                </div>
            </form>
        </div>  
    </section>
