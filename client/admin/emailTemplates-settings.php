<?php
    ...
    //SELECT EMAIL AUTOMATION
        $sql = "SELECT * FROM tbl_email_settings LIMIT 1";
    ...
    <section>
        ...
        <div class="content-holder">
            <div class="action-buttons">
                <a href="emailTemplates.php" name=generalBTN class="">
                    <i class="bi bi-envelope-arrow-up-fill"></i>
                    <p>Account Creation</p>
                </a>
                <a href="emailTemplates-approval.php" name="formsBTN" >
                    <i class="bi bi-envelope-arrow-up-fill"></i>
                ...
                <a href="emailTemplates-settings.php" name="formsBTN" class="selected">
        ...
        <div class="content-holder">
            <form action="../../server/email_manipulation.php" method="get">
                ...
                <div class="input-holder">
                    <p>App Password: <a href="https://support.google.com/mail/answer/185833?hl=en" target="_blank"><i class="bi bi-info-circle-fill"></i></a></p>
                    <input type="text" name="appPassword" value="<?php echo $password?>">
                </div>
                <div class="button-holder">
                    <button name="emailSettingSave" value="<?php echo $id?>"><i class="bi bi-floppy"></i> SAVE</button>
                </div>
            </form>
        </div>
    </section>
