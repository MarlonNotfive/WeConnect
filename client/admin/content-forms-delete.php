    ...
    // TBL FORM = id REQUEST
        ...
        if ($result) {
            ...
            if ($row) {
                ...
                $formDepartment = $row['form_department'];
...
<body>
    ...
    <section id="scroll-listener">
        <div class="title">
            <h1>MANAGE CONTENT / DELETE FORM</h1>
        ...
        <div class="content-holder">
            <form action="../../server/content_handler.php" method="get" class="animation-fadeIn">
                <div class="input-holder">
                    ...
                    <input type="text" disabled value="<?php echo $formTitle?>">
                </div>
                <div class="input-holder">
                    <label for="">Form Link:</label>
                    <input type="text" disabled value="<?php echo $formLink?>">
                </div>
                <div class="input-holder">
                    <label for="">Form Group:</label>
                    <input type="text" disabled value="<?php echo $formDepartment?>">
                </div>
                <div class="button-holder">
                    <button name="delete-form" value="<?php echo $id?>"><i class="bi bi-trash3"></i></button>
