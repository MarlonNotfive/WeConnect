        ...
        if(isset($_GET['delete'])) {
            ...
            if ($result) {
                ...
                if ($row) {
                    ...
                    $eventDepartment = $row['event_department'];
...
<body>
    ...
    <section id="scroll-listener">
        <div class="title">
            <h1>MANAGE CONTENT / DELETE EVENT</h1>
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="input-holder">
                            ...
                            <input type="text" name="eventTitle" value="<?php echo $eventTitle?>" required disabled>
                        </div>
                        <div class="input-holder">
                        ...
                        <div class="input-holder">
                            ...
                            <input type="date" name="eventDate" value="<?php echo $eventDate?>" required disabled>
                        </div>
                        <div class="input-holder">
                            <label for="">Time:</label>
                            <input type="time" name="eventTime" value="<?php echo $eventTime?>" required disabled>
                        </div>
                        <div class="input-holder">
                            <label for="">Department:</label>
                            <select name="department" id="" disabled> 
                                <option value="Dept1" <?php echo ($eventDepartment === "Dept1" ? 'selected' : '') ?>>Dept1</option>
                                <option value="Dept2" <?php echo ($eventDepartment === "Dept2" ? 'selected' : '') ?>>Dept2</option>
                                <option value="Dept3" <?php echo ($eventDepartment === "Dept3" ? 'selected' : '') ?>>Dept3</option>
                                <option value="Dept4" <?php echo ($eventDepartment === "Dept4" ? 'selected' : '') ?>>Dept4</option>
                                <option value="Dept5" <?php echo ($eventDepartment === "Dept5" ? 'selected' : '') ?>>Dept5</option>
                                <option value="Dept6" <?php echo ($eventDepartment === "Dept6" ? 'selected' : '') ?>>Dept6</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-col">
                        <div class="input-holder">
                            ...
                            <textarea name="eventSummary" value="" id="" cols="30" rows="5" disabled><?php echo $eventSummary?></textarea>
                        </div>
                        <div class="input-holder">
                            <label for="">Event Description:</label>
                            <textarea name="eventDesc" value="" id="" cols="30" rows="7" disabled><?php echo $eventDesc?></textarea>
                        </div>
                    </div>
                </div>
                <div class="button-holder">
                    <button name="deleteEventBTN" value="<?php echo $id?>"><i class="bi bi-trash3"></i></button>
