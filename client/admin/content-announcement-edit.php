...
<body>
    ...
    <section id="scroll-listener">
        <div class="title">
            <h1>MANAGE CONTENT / EDIT ANNOUNCEMENT</h1>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <div class="input-holder">
                            ...
                            <textarea name="Summary" value="" id="" cols="30" rows="5"><?php echo $summary?></textarea>
                        </div>
                        <div class="input-holder">
                            <label for="">Event Description:</label>
                            <textarea name="Desc" value="" id="" cols="30" rows="7"><?php echo $desc?></textarea>
                        </div>
                    </div>
                </div>
                <div class="button-holder">
                    <button name="editAnnouncementBTN" value="<?php echo $id?>"><i class="bi bi-floppy"></i></button>
